...
#import "CabbageCell.h"
#import "NetworkTool.h"
@interface CabbageTableVC ()

@end

@implementation CabbageTableVC
...
- (void)viewDidLoad {
    ...
    for (int i = 0; i< 2; i++)
    {
        [NetworkTool  getCabbageIndex:i CompletionBlock:^(NSDictionary *dic){
...
{
    CabbageCell * cell  =[_publicTable dequeueReusableCellWithIdentifier:@"cell"];
    if (!cell) {
        cell = [[[CabbageCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"cell"] autorelease];
    }
...
-(void)clickBtn:(UIButton*)sender
{
    ...
    _scrollViewTop.contentOffset = CGPointMake(index*0, 0);
}
