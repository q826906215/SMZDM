...
#import "MiracleTableVC.h"
#import "MiracleCell.h"
#import "NetworkTool.h"

@interface MiracleTableVC ()

@end

@implementation MiracleTableVC
...
{
    MiracleCell * cell  =[_publicTable dequeueReusableCellWithIdentifier:@"cell"];
    if (!cell) {
        cell = [[[MiracleCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"cell"] autorelease];
           }
