...
@implementation BaskinContentSt
...
- (void)viewDidLoad {
    ...
    [Network getFistPageInformationDataWithGoodsID:self.good.articleId CompletionBlock:^(NSDictionary *dic) {
        
        preferentialClass =[BaskInContentBaseClass modelObjectWithDictionary:dic];
        
        [webView loadHTMLString:self.good.articleFilterContent baseURL:nil];
    ...
    UILabel *theNameThe=[[UILabel alloc]initWithFrame:CGRectMake(10, 175, 100, 20)];
    
    theNameThe.text=self.good.articleTitle;
    ...
    UILabel *time =[[UILabel alloc]initWithFrame:CGRectMake(250, 175, 150, 20)];
