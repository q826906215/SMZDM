...
- (void)viewDidLoad {
    ...
    [Network getFistPagefoundWithGoodsID:self.good.articleId CompletionBlock:^(NSDictionary *dic) {
        
    preferentialClass =[foundStBaseClass modelObjectWithDictionary:dic];
