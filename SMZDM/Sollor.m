...
- (void)viewDidLoad {
    ...
    [Network getFistPageHaiTaoDataWithGoodsID:self.good.articleId CompletionBlock:^(NSDictionary *dic) {
...
- (UIView *)scrollViewItemWithY:(CGFloat)y andNumber:(int)num {
    ...
    things.text =preferentialClass.data. articleTitle;
    ...
    theRice.text=preferentialClass.data.articlePrice;
