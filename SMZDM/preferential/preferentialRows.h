...
@class preferentialArticleMallClient;

@interface preferentialRows : NSObject <NSCoding, NSCopying>

@property (nonatomic, retain) preferentialArticleMallClient *articleMallClient;
